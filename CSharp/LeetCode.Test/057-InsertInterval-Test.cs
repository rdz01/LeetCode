...
namespace LeetCode.Test
{
    ...
    public class _057_InsertInterval_Test
    {
        ...
        public void InsertTest_NoOverlap_Before()
        {
            var input = new[]
            {
                new _057_InsertInterval.Interval(4, 6),
                new _057_InsertInterval.Interval(8, 10)
            };

            var solution = new _057_InsertInterval();
            var result = solution.Insert(input, new _057_InsertInterval.Interval(1, 3));
        ...
        public void InsertTest_NoOverlap_Middle()
        {
            var input = new[]
            {
                new _057_InsertInterval.Interval(1, 3),
                new _057_InsertInterval.Interval(8, 10)
            };

            var solution = new _057_InsertInterval();
            var result = solution.Insert(input, new _057_InsertInterval.Interval(4, 6));
        ...
        public void InsertTest_NoOverlap_Last()
        {
            ...
            var solution = new _057_InsertInterval();
            var result = solution.Insert(input, new _057_InsertInterval.Interval(8, 10));
        ...
        public void InsertTest_Overlap()
        {
            ...
            {
                new _057_InsertInterval.Interval(1, 3),
                new _057_InsertInterval.Interval(6, 9)
            };

            var solution = new _057_InsertInterval();
            var result = solution.Insert(input, new _057_InsertInterval.Interval(2, 5));
        ...
        public void InsertTest_MultipleOverlap()
        {
            var input = new[]
            {
                new _057_InsertInterval.Interval(1, 2),
                new _057_InsertInterval.Interval(3, 5),
                new _057_InsertInterval.Interval(6, 7),
                new _057_InsertInterval.Interval(8, 10),
                new _057_InsertInterval.Interval(12, 16)
            };

            var solution = new _057_InsertInterval();
            var result = solution.Insert(input, new _057_InsertInterval.Interval(4, 9));
        ...
        {
            var solution = new _057_InsertInterval();
            var result = solution.Insert(new _057_InsertInterval.Interval[] { }, new _057_InsertInterval.Interval(4, 6));
