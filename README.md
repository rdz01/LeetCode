...
|6|[ZigZag Conversion](./Problems/006-ZigZagConversion.md)| C [C++](./C++/LeetCode/006-ZigZagConversion.cpp)(16ms) [C#](./CSharp/LeetCode/006-ZigZagConversion.cs)(148ms) Java JavaScript Python Ruby | O(N) | O(N) | |
|7|[Reverse Integer](./Problems/007-ReverseInteger.md)| C [C++](./C++/LeetCode/007-ReverseInteger.cpp)(8ms) [C#](./CSharp/LeetCode/007-ReverseInteger.cs)(64ms) Java JavaScript Python Ruby | O(1) | O(1) | |
|8|[String to Integer (atoi)](./Problems/008-StringToInteger(atoi).md)| C [C++](./C++/LeetCode/008-StringToInteger(atoi).cpp)(8ms) [C#](./CSharp/LeetCode/008-StringToInteger(atoi).cs)(144ms) Java JavaScript Python Ruby | O(1) | O(1) | |
...
|49|[Group Anagrams](./Problems/049-GroupAnagrams.md)| C C++ [C#](./CSharp/LeetCode/049-GroupAnagrams.cs)(580ms) Java JavaScript Python Ruby | O(N) | O(N) | |
|50|[Pow(x, n)](./Problems/050-Pow.md)| C C++ [C#](./CSharp/LeetCode/050-Pow.cs)(64ms) Java JavaScript Python Ruby | O(LogN) | O(1) | |
|51|[N-Queens](./Problems/051-NQueens.md)| C C++ [C#](./CSharp/LeetCode/051-NQueens.cs)(396ms) Java JavaScript Python Ruby | O(N!) | O(N) | |
...
|77|[Combinations](./Problems/077-Combinations.md)| C C++ [C#](./CSharp/LeetCode/077-Combinations.cs)(416ms) Java JavaScript Python Ruby | O((N-K)!) | O(N!/K!) | |
...
|84|[Largest Rectangle in Histogram](./Problems/084-LargestRectangleInHistogram.md)| C C++ [C#](./CSharp/LeetCode/084-LargestRectangleInHistogram.cs)(156ms) Java JavaScript Python Ruby | O(N) | O(N) | |
|85|[Maximal Rectangle](./Problems/085-MaximalRectangle.md)| C C++ [C#](./CSharp/LeetCode/085-MaximalRectangle.cs)(176ms) Java JavaScript Python Ruby | O(N*M) | O(M) | |
|86|[Partition List](./Problems/086-PartitionList.md)| C C++ [C#](./CSharp/LeetCode/086-PartitionList.cs)(148ms) Java JavaScript Python Ruby | O(N) | N(1) | |
