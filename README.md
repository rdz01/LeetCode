...
|C#|[![Build Status](https://ci.appveyor.com/api/projects/status/github/bigegg/leetcode?branch=csharp&svg=true&retina=true)](https://ci.appveyor.com/project/bigegg/leetcode/branch/csharp)|[![Solved Problems](https://img.shields.io/badge/Last%20Problem%20ID-26-blue.svg)](https://github.com/BigEgg/LeetCode/tree/CSharp)|
...
|26|[Remove Duplicates from Sorted Array](./Problems/026-RemoveDuplicatesFromSortedArray.md)| C C++ [C#](./CSharp/LeetCode/026-RemoveDuplicatesFromSortedArray.cs)(564ms) Java JavaScript Python Ruby | | | |
