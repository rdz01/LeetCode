...
|5|[Longest Palindromic Substring](./Problems/005-LongestPalindromicSubstring.md)| C [C++](./C++/LeetCode/005-LongestPalindromicSubstring.cpp)(4ms) [C#](./CSharp/LeetCode/005-LongestPalindromicSubstring.cs)(128ms) [Java](./Java/src/main/java/bigegg/leetcode/_005_LongestPalindromicSubstring.java)(340ms) [JavaScript](./JavaScript/src/005-LongestPalindromicSubstring.js)(156ms) Python Ruby | O(N) | O(N) | Use Manacher's Algorithm |
